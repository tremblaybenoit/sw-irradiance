...
if __name__ == "__main__":
    ...
    for cfgi,cfgPath in enumerate(cfgs):
        ...
        test_real = SW_Dataset(EVE_path_orig, data_root, data_root, resolution, cfg['eve_transform'], cfg['eve_sigmoid'], split = phase, AIA_transform = aia_transform, crop = crop, flip = flip, crop_res = crop_res, zscore = zscore,self_mean_normalize=True)
